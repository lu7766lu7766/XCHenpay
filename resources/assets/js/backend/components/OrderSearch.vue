            ...
            <div class="clearfix">
                <div class="col-sm-3 col-md-2">
                    <select class="form-control" v-model="pay_state">
                        ...
                        <option v-for="(name, val) in options.payState" :value="val">{{ name }}</option>
                    </select>
                </div>
                <div class="col-sm-3 col-md-2">
                    <select class="form-control" v-model="payment_type">
                        <option v-for="(name, val) in options.paymentType" :value="val">{{ name }}</option>
                    </select>
                </div>
                <div class="col-sm-3 col-md-2">
                            ...
                            <table class="table table-hover text-center table-bordered table-box dataTable"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="order-sort" rowspan="1" colspan="1"
                                        aria-label="金额: activate to sort column ascending" style="width: 117px;">金额
                                    </th>
                                    ...
                                    <th class="date sorting" tabindex="0" aria-controls="order-sort" rowspan="1"
                                        colspan="1"
                                        aria-label="申请时间: activate to sort column ascending" style="width: 170px;">申请时间
                                    </th>
                                ...
                                <tr role="row" class="odd" v-for="(data, index) in datas" :key="index">
                                    ...
                                    <td>2018-10-16 08:00:31</td>
                                    <td class="control">
                                        <a><i class="livicon" data-name="info" data-size="18" data-c="#428BCA"
                                        ...
                                        <a><i class="livicon" data-name="edit" data-size="18" data-c="#f56954"
                                ...
                                <tr>
                                    ...
                                    <td class="text-right" rowspan="1" colspan="1">2,123</td>
                                    <td rowspan="1" colspan="1"></td>
                                    <td class="text-right" rowspan="1" colspan="1">53.075</td>
                                    <td rowspan="1" colspan="1"></td>
                                    <td rowspan="1" colspan="1"></td>
                                </tr>
                                </tfoot>
