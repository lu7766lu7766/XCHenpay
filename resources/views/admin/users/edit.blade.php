                                ...
                                {!! Form::model($user, ['url' => URL::to('admin/users/'. $user->id.''), 'method' => 'put', 'class' => 'form-horizontal','id'=>'commentForm', 'enctype'=>'multipart/form-data','files'=> true]) !!}
                                    ...
                                    <div id="rootwizard">
                                        <ul>
                                            ...
                                            <li><a href="#tab2" data-toggle="tab">@lang('users/EditProfile/form.bio')</a></li>
                                            <li><a href="#tab3" data-toggle="tab">@lang('users/EditProfile/form.address')</a></li>
                                            <li><a href="#tab4" data-toggle="tab">@lang('users/EditProfile/form.UserGroup')</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane" id="tab1">
                                                ...
                                                <div class="form-group {{ $errors->first('email', 'has-error') }}">
                                                    <label for="email" class="col-sm-2 control-label">@lang('users/EditProfile/form.user_email') *</label>
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="tab-pane" id="tab2" disabled="disabled">
                                                ...
                                                <div class="form-group {{ $errors->first('dob', 'has-error') }}">
                                                    <label for="dob" class="col-sm-2 control-label">@lang('users/EditProfile/form.birth')</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group {{ $errors->first('pic_file', 'has-error') }}">
                                                    <label for="pic" class="col-sm-2 control-label">@lang('users/EditProfile/form.picture')</label>
                                                    <div class="col-sm-10">
                                                    ...
                                                    <span class="btn btn-default btn-file">
                                                        <span class="fileinput-new">@lang('users/EditProfile/form.select_picture')</span>
                                                        <span class="fileinput-exists">@lang('users/EditProfile/form.change_picture')</span>
                                                        <input id="pic" name="pic_file" type="file"
                                                               class="form-control"/>
                                                    </span>
                                                                <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput" style="color: black !important;">@lang('users/EditProfile/form.remove')</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group  {{ $errors->first('pic', 'has-error') }}">
                                                    <label for="bio" class="col-sm-2 control-label">@lang('users/EditProfile/form.bio')</label>
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="tab-pane" id="tab3" disabled="disabled">
                                                <div class="form-group {{ $errors->first('gender', 'has-error') }}">
                                                    <label for="email" class="col-sm-2 control-label">@lang('users/EditProfile/form.gender') </label>
                                                    <div class="col-sm-10">
                                                        <select class="form-control" title="Select Gender..." name="gender">
                                                            <option value="">Select</option>
                                                            <option value="male" @if($user->gender === 'male') selected="selected" @endif >@lang('users/EditProfile/form.male')</option>
                                                            <option value="female" @if($user->gender === 'female') selected="selected" @endif >@lang('users/EditProfile/form.female')</option>
                                                            <option value="other" @if($user->gender === 'other') selected="selected" @endif >@lang('users/EditProfile/form.other')</option>
                                                ...
                                                <div class="form-group {{ $errors->first('city', 'has-error') }}">
                                                    <label for="city" class="col-sm-2 control-label">@lang('users/EditProfile/form.city') </label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group {{ $errors->first('postal', 'has-error') }}">
                                                    <label for="postal" class="col-sm-2 control-label">@lang('users/EditProfile/form.postal')</label>
                                                    <div class="col-sm-10">
